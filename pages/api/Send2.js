  ...
  const message2 = {
   ...
   <div style="display: inline-flex;">
       <div style="margin-top: -20px; ">
           ...
           <p>
           <h4>Nom </h4>${req.body.nom}<br><h4>Joignable à l'adresse : </h4> ${req.body.email}
           </p>
       </div>
   </div>
</div>
