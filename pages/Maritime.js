                                    ...
                                    <div className="w-full flex justify-between items-center">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-col gap-2 p-4">
                                                ...
                                                <button className="bg-cyan-800 text-white rounded-md py-2 px-8 max-[768px]:p-2" onClick={() => { makeDevis("Africolis", tab1); }}>
                                                    Choisir
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div className="w-full flex justify-between items-center">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-col gap-2 p-4 ">
                                                ...
                                                <button className="bg-cyan-800 text-white rounded-md py-2 px-8 max-[768px]:p-2" onClick={() => {makeDevis("Challenge N°1", tab2); }}>Choisir</button>                                       
                                            </div>
                                        </div>
                                    </div>
                                </div>
